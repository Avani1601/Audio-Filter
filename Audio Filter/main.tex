...
\vspace{3cm}
\title{Audio Filter}
\author{EE23BTECH11205 - Avani Chouhan $^{*}$% <-this % stops a space
}
\maketitle
\newpage
\bigskip
...
\begin{lstlisting}
https://github.com/Avani1601/Audio-Filter/blob/main/Audio%20Filter/codes/doha.wav
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Avani1601/Audio-Filter/blob/main/Audio%20Filter/codes/3.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/Avani1601/Audio-Filter/blob/main/Audio%20Filter/codes/3.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Avani1601/Audio-Filter/blob/main/Audio%20Filter/codes/4.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Avani1601/Audio-Filter/blob/main/Audio%20Filter/codes/5.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Avani1601/Audio-Filter/blob/main/Audio%20Filter/codes/hndef.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/Avani1601/Audio-Filter/blob/main/Audio%20Filter/codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Avani1601/Audio-Filter/blob/main/Audio%20Filter/codes/6.123.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Avani1601/Audio-Filter/blob/main/Audio%20Filter/codes/6.4.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Avani1601/Audio-Filter/blob/main/Audio%20Filter/codes/6.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Avani1601/Audio-Filter/blob/main/Audio%20Filter/codes/7.1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{align}
	&y(n) - \brak{3.66}y(n - 1) + \brak{5.031}y(n - 2) \nonumber \\
	&- \brak{3.08}y(n - 3) + \brak{0.710}y(n - 4) \nonumber \\
	&= \brak{1.555\times 10^{-5}}x(n) + \brak{6.22 \times 10^{-5}}x(n - 1) \nonumber \\
	&+ \brak{9.33 \times 10^{-5}}x(n - 2) + \brak{6.22 \times 10^{-5}}x(n - 3) \nonumber \\
...
\begin{lstlisting}
https://github.com/Avani1601/Audio-Filter/blob/main/Audio%20Filter/codes/7.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Avani1601/Audio-Filter/blob/main/Audio%20Filter/codes/filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\\
\solution The given butterworth filter is lowpass with order=4 and cutoff-frequency=7kHz.
